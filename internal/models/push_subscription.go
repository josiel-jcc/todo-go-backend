...
type PushSubscription struct {
	...
	// varchar(512): MySQL cannot unique-index TEXT without a prefix length
	Endpoint  string         `json:"endpoint" gorm:"type:varchar(512);not null;uniqueIndex:idx_push_subscriptions_user_endpoint"`
